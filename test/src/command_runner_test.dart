...
import 'package:flutter_config_switcher/src/command_runner.dart';
...
void main() {
  group('FlutterConfigSwitcherCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlutterConfigSwitcherCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlutterConfigSwitcherCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlutterConfigSwitcherCommandRunner();
