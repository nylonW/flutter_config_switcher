...
abstract class $FirebaseConfigCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String? token, String project});
}
...
class _$_FirebaseConfig implements _FirebaseConfig {
  _$_FirebaseConfig(
      {required this.email, required this.token, required this.project});
  ...
  @override
  String toString() {
    return 'FirebaseConfig(email: $email, token: $token, project: $project)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, email, token, project);
...
abstract class _FirebaseConfig implements FirebaseConfig {
  factory _FirebaseConfig(
      ...
      required final String project}) = _$_FirebaseConfig;
